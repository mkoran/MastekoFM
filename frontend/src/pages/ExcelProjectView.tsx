...
export default function ExcelProjectView() {
  ...
  const handleCalculate = async () => {
    ...
    setMessage(null)
    try {
      const run = await api.post<RunRecord>(`/excel-projects/${projectId}/scenarios/${selectedId}/calculate`, {})
      setMessage({
  ...
  const handleUploadNewVersion = async () => {
    ...
    try {
      ...
      fd.append('file', file)
      const resp = await fetch(`/api/excel-projects/${projectId}/scenarios/${selectedId}/upload`, {
        method: 'POST',
